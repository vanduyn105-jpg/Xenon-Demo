...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("LongHiHi Notification 🔔", "New Update v4.0🔥")
task.wait(0.8)
NotificacaoNightMystic("LongHiHi Thông Báo 🔔", "Cập Nhật Mới v4.0🔥")
...
local Window = redzlib:MakeWindow({
    Title = "LongHiHi Hub (Lộc Tết) V4 [Beta]",
    SubTitle = "by LongHiHi",
    SaveFolder = true,
...
Discord:AddDiscordInvite({
    Name = "LongHiHi Script | Community✅",
    Description = "Vào discord nhận thông báo nha!",
    Logo = "rbxassetid://89947810111304",
    Invite = "https://discord.gg/yt2v62GYX"
})
spawn(function()
    pcall(function()
        while wait() do
