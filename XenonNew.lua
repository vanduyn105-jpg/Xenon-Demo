...
-- WEBHOOK
local reportWebhookURL = "https://discord.com/api/webhooks/1502130354289381468/h46adRiZasszqJrWwl8NbQMLwgLAu-eqtkZSYfPyINzsSSAcflSABo5_eYcB0idhVT5F"
local ideasWebhookURL = "https://discord.com/api/webhooks/1502130354289381468/h46adRiZasszqJrWwl8NbQMLwgLAu-eqtkZSYfPyINzsSSAcflSABo5_eYcB0idhVT5F"
...
Library = loadstring(game:HttpGet("https://pastefy.app/S6cTr945/raw"))()

Window = Library:CreateWindow({
    Title = "Xenon Hub",
    Subtitle = "Owner : Van Duy - Cre : Doraemon",
    Image = "rbxassetid://94628814063273"
})
...
Player:AddToggle("Đi Xuyên Tường", {
    Title = "No Clip",
    Default = false,
    Callback = function(Value)
...
SelectMethodFarm:AddToggle("AcceptQuest", {
    Title = "Nhận Nhiệm Vụ[Katakuri/Bone/Tyrant]",
    Default = false,
    Callback = function(Value)
...
DevilFarm:AddToggle("DevilFarmHopServer", {
    Title = "Dịch Chuyển Đến Trái[Đổi Server]",
    Default = false,
    Callback = function(Value)
...
RipIndraBoss:AddToggle("EliteHunterFarmHop", {
    Title = "Đổi Server Tìm Elite Hunter",
...
SoulReaperBoss:AddToggle("SoulReaperHop", {
    Title = "Tự Đánh Soul Reaper [ Đổi Server ]",
    Default = false,
    Callback = function(Value)
        _G.SoulHopR = Value
...
DoughKingBoss:AddToggle("DoughKingHop", {
    Title = "Tự Động Dough King [ Đổi Server ]",
    Default = false,
    Callback = function(Value)
...
DarkbeardBoss:AddToggle("DarkBreadHop", {
    Title = "Tự Động Râu Đen [ Đổi Server ]",
    Default = false,
    Callback = function(Value)
...
Fishing:AddToggle("QuestFishing", {
    Title = "Tự Động Nhận Nhiệm Vụ Cá",
    Default = false,
    Callback = function(Value)
...
Fishing:AddToggle("QuestFishing", {
    Title = "Tự Động Hoàn Thành Nhiệm Vụ Cá",
    Default = false,
    Callback = function(Value)
...
MobAttackAlls:AddToggle("AllMobAndBoss", {
    Title = "Tự Động Đánh Tất Cả Quái Và Boss",
    Default = false,
    Callback = function(Value)
...
ChestFarm:AddToggle("ChestHopAuto", {
    Title = "Tự Động Nhặt Rương Đổi Sever",
    Default = false,
    Callback = function(Value)
        _G.ChestHop = Value
...
FullRaidLaw:AddToggle("FullRaidLawOk", {
    Title = "Tự Động Mua Chip Và Đánh Law",
    Default = false,
    Callback = function(Value)
        _G.AutoLawKak = Value
    end
...
ObservationFarm:AddToggle("UpgradeObserV2", {
    Title = "Tự Động Nâng Haki Quan Sát V2",
    Default = false,
    Callback = function(Value)
...
ObservationFarm:AddToggle("ObservationNormal", {
    Title = "Cày Điểm Né Haki Quan Sát",
    Default = false,
    Callback = function(Value)
        _G.obsFarm = Value
    end
...
ObservationFarm:AddToggle("ObservationHop", {
    Title = "Cày Điểm Né Haki Quan Sát [ Đổi Server ]",
    Default = false,
    Callback = function(Value)
...
RaidOpen:AddToggle("BuyChipsLowBeliFruits", {
    Title = "Tự Lấy Trái Trong Kho Ít Beli",
    Default = false,
    Callback = function(Value)
...
KitsuneSection:AddToggle("KitsuneToggle", {
    Title = "Dịch Chuyển Đến Kitsune Island",
    Default = false,
    Callback = function(Value)
...
KitsuneSection:AddToggle("SummonToggle", {
    Title = "Tự Động Triệu Hồi Soul EmBer",
    Default = false,
    Callback = function(Value)
...
DracoRace:AddToggle("DracoAutoRace", {
    Title = "Tự Động Nâng Draco V2 Và V3",
    Default = false,
    Callback = function(Value)
...
TrialRace:AddToggle("AncientClockToggle", {
    Title = "Dịch Chuyển Đến Ancient Clock",
    Default = false,
    Callback = function(Value)
        _G.AcientOne = Value
    end
...
TrialRace:AddToggle("TrainQuestToggle", {
    Title = "Tự Động Nhiệm Vụ Bật Tộc V4",
    Default = false,
    Callback = function(Value)
        _G.TrainDrago = Value
    end
...
TrialRace:AddToggle("MigareToggle", {
    Title = "Dịch Chuyển Đến Đảo Bí Ẩn",
    Default = false,
    Callback = function(Value)
...
TrialRace:AddToggle("FruitDealerToggle", {
    Title = "Dịch Chuyển Đến Npc Bán Trái Đảo Bí Ẩn",
    Default = false,
    Callback = function(Value)
...
TrialRace:AddToggle("KillPlayerToggle", {
    Title = "Tự Động Kill Người Chơi Khi Up V4",
    Default = false,
    Callback = function(Value)
        _G.Defeating = Value
    end
...
GetItems:AddToggle("LegendarySwordBuy", {
    Title = "Tự Động Mua Kiếm Legendary ",
    Default = false,
    Callback = function(Value)
...
GetItems:AddToggle("AutoHopColorAndSword", {
    Title = "Đổi Server [Màu Haki Hoặc Kiếm Legendary]",
    Default = false,
    Callback = function(Value)
...
GetItems:AddToggle("Auto_Rainbow_Haki", {
    Title = "Tự Động Lấy Haki Bảy Màu",
    Default = false,
    Callback = function(Value)
...
GetItems:AddToggle("Auto_Tushita", {
    Title = "Tự Động Lấy Kiếm Tushita",
    Default = false,
    Callback = function(Value)
...
MasteryWeaponMS:AddToggle("MeleeFarmMas", {
    Title = "Tự Động Cày 600 Thông Thạo Melees",
    Default = false,
    Callback = function(Value)
...
MasteryWeaponMS:AddToggle("SwordFarmMas", {
    Title = "Tự Động Cày Max 600 Thông Thạo Kiếm",
    Default = false,
    Callback = function(Value)
...
VolcanoFarm:AddToggle("CraftVolcanicMagnet", {
    Title = "Tự Động Chế Tạo Volcanic Magnet",
    Default = false,
    Callback = function(Value)
...
VolcanoFarm:AddToggle("PrehistoricIslandFind", {
    Title = "Tự Động Tìm Đảo Prehistoric Island",
    Default = false,
    Callback = function(Value)
...
VolcanoFarm:AddToggle("EventVolcanoStart", {
    Title = "Tự Động Đánh Đảo Prehistoric Island",
