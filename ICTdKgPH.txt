...
nz.NotiGui.Name = "LongHiHi Notification";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Banana Cat Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">BANANA CAT HUB : BLOX FRUIT</font> : Blox Fruits");
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Banana Cat Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
...
zP.CreateButton({ Title = "LongHiHi Script | Community", Callback = function()
